...
(function(b) {
    ...
    var d = function() {
        ...
        a.prototype.readUnsignedShort = function() {
            ...
            if (0 == (this.position & 1)) {
                var c = new Uint16Array(this.arraybytes),
                    a = this.position >> 1;
                this.position += 2;
                return c[a]
            }
        ...
        a.prototype.readUnsignedInt = function() {
            ...
            if (0 == (this.position & 3)) {
                var c = new Uint32Array(this.arraybytes),
                    a = this.position >> 2;
                this.position += 4;
                return c[a]
            }
        ...
        a.prototype.readFloat = function() {
            if (this.position > this.length + 4) throw "ByteArray out of bounds read. Positon=" + this.position + ", Length=" +
                this.length;
            if (0 == (this.position & 3)) {
                var c = new Float32Array(this.arraybytes),
                    a = this.position >> 2;
                this.position += 4;
                return c[a]
            }
...
(function(b) {
    var e = function(d) {
        ...
        a.pauseTweens = function(c) {
            if (c.tween_count)
                for (var a = b.Tween._tweens, d = a.length - 1; 0 <= d; d--) a[d]._target == c && (a[d].paused = !0)
        };
        a.resumeTweens = function(c) {
            if (c.tween_count)
                for (var a = b.Tween._tweens, d = a.length - 1; 0 <= d; d--) a[d]._target == c && (a[d].paused = !1)
        };
        a.tick = function(c, b) {
            void 0 === b && (b = !1);
...
(function(b) {
    var e = function(b) {
        ...
        a.prototype.draw = function() {
            var a = "equal";
            1 == this.bikeIndex && (a = "plus");
            var b = ["greenBox", "redBox"][Math.floor(2 * Math.random())];
            this.bikeImg = this.createBitmapByName(b);
            this.addChild(this.bikeImg);
            this.width = this.bikeImg.width;
            this.height = this.bikeImg.height;
            this.bikeLogo = this.createBitmapByName(a);
            this.bikeLogo.anchorX = 0.5;
            this.bikeLogo.anchorY = 0.5;
            this.bikeLogo.x = 0.5 * this.width;
            this.bikeLogo.y =
                0.5 * this.height + 25;
            this.addChild(this.bikeLogo)
        };
        a.prototype.removeSelf = function() {};
        a.prototype.getBikeIndex = function() {
    ...
    b.Bike = e;
    e.prototype.__class__ = "robBike.Bike"
})(robBike || (robBike = {}));
__extends = this.__extends || function(b, e) {
    function d() {
        this.constructor = b
...
(function(b) {
    var e = function(b) {
        function a() {
            b.call(this);
            this.touchEnabled = !0;
            this.gameInfoBg = this.createBitmapByName("focusBg");
            ...
            this.gameInfo.x = 0.5 * this.gameInfoBg.width;
            this.gameInfo.y = 0.5 * this.gameInfoBg.height;
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.gameOverScene = function() {
            ...
            b.GameOver.indexBg = b.GameOver.createBitmapByName("indexBg");
            ...
            b.GameOver.focusBtn.y = 50;
           // b.GameOver.bgContain.addChild(b.GameOver.focusBtn);
           ...
           // b.GameOver.bgContain.addChild(a);
            ...
            b.GameOver.scoreLabel.text = "\u5728\u77ed\u77ed\u0033\u0030\u79d2\u6210\u529f\u9605\u5377" + String(b.GameOver.score) + "\u6b21";
			dp_share(b.GameOver.score);
			//dp_submitScore(-1,b.GameOver.score);
			
            b.GameOver.scoreLabel.x = 0.5 * b.GameOver.winWidth;
            b.GameOver.scoreLabel.y = 0.46 * b.GameOver.winHeight;
            b.GameOver.scoreLabel.textColor = 0;
            ...
            b.GameOver.retryBtn.y = 0.8 * b.GameOver.winHeight - 20;
            ...
            b.GameOver.moreBtn.y = 0.9 * b.GameOver.winHeight - 10;
    ...
    b.GameOver = e;
    e.prototype.__class__ = "robBike.GameOver"
})(robBike || (robBike = {}));
__extends = this.__extends || function(b, e) {
    function d() {
        this.constructor = b
...
(function(b) {
    var e = function(b) {
        ...
        a.prototype.draw = function() {
            var a = "leftBtn",
                b = "leftBtn_light";
            1 == this.touchIndex && (a = "rightBtn", b = "rightBtn_light");
            this.btnBg = this.createBitmapByName(a);
            this.addChild(this.btnBg);
            this.btnBg_light = this.createBitmapByName(b);
            this.btnBg_light.alpha = 0;
            this.addChild(this.btnBg_light);
            this.width = this.btnBg.width;
            this.height = this.btnBg.height
        };
        a.prototype.getTouchIndex = function() {
            return this.touchIndex
        };
        a.prototype.touchDown = function() {
            this.btnBg_light.alpha = 1
        };
    ...
    b.TouchArea = e;
    e.prototype.__class__ = "robBike.TouchArea"
})(robBike || (robBike = {}));
__extends = this.__extends || function(b, e) {
    function d() {
        this.constructor = b
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.initGameScene = function() {
            ...
            b.GameScene.bikes = [];
            b.GameScene.tapEventQueue = [];
            b.GameScene.score = 0;
            b.GameScene.bikeMoving = !1;
            b.GameScene.isGameStart = !1;
            b.GameScene.isGameOver = !1;
            b.GameScene.gameBg = new egret.Sprite;
            b.GameScene.gameBg.name =
                "gameBg";
            ...
            b.GameScene.gameInfo = new Utils.GameInfo;
            b.GameScene.gameBg.addChild(b.GameScene.gameInfo);
            b.GameScene.gameInfo.addEventListener(egret.TouchEvent.TOUCH_TAP, b.GameScene.gameInfoTouched, this);
        };
        a.createGameContainer = function() {
            b.GameScene.bgContainer = new egret.Sprite;
            b.GameScene.bgContainer.graphics.beginFill(1118481);
            b.GameScene.bgContainer.graphics.drawRect(0, 0, b.GameScene.winWidth, b.GameScene.winHeight);
            b.GameScene.bgContainer.graphics.endFill();
            b.GameScene.gameBg.addChild(b.GameScene.bgContainer);
            b.GameScene.backgroundImg = this.createBitmapByName("gameBg");
            b.GameScene.bgContainer.addChild(b.GameScene.backgroundImg);
            b.GameScene.createContentGroupByLevel(0)
        };
        a.createContentGroupByLevel = function(a) {
            b.GameScene.backGroup = new egret.Sprite;
            b.GameScene.backGroup.y = b.GameScene.winHeight - 320;
            b.GameScene.bgContainer.addChild(b.GameScene.backGroup);
            b.GameScene.contentGroup = new egret.Sprite;
            b.GameScene.bgContainer.addChild(b.GameScene.contentGroup);
            b.GameScene.frontGroup = new egret.Sprite;
            b.GameScene.frontGroup.y = b.GameScene.winHeight - 320;
            b.GameScene.bgContainer.addChild(b.GameScene.frontGroup);
            b.GameScene.createHand();
            b.GameScene.shadow = b.GameScene.createBitmapByName("shadow");
            b.GameScene.shadow.anchorX = 0.5;
            b.GameScene.shadow.anchorY = 0.5;
            b.GameScene.shadow.x = 0.5 * b.GameScene.winWidth;
            b.GameScene.shadow.y = b.GameScene.winHeight - 235;
            b.GameScene.contentGroup.addChild(b.GameScene.shadow);
            for (a = 0; 8 > a; a++) b.GameScene.bikeEnqueue();
            b.GameScene.leftTouchArea = new b.TouchArea(0);
            b.GameScene.leftTouchArea.anchorX = 0.5;
            b.GameScene.leftTouchArea.x = 0.5 * (b.GameScene.winWidth - b.GameScene.leftTouchArea.width) - 20;
            b.GameScene.leftTouchArea.y = b.GameScene.winHeight - 115;
            b.GameScene.contentGroup.addChild(b.GameScene.leftTouchArea);
            b.GameScene.leftTouchArea.addEventListener(egret.TouchEvent.TOUCH_BEGIN, b.GameScene.areaTouchEvent_down, b.GameScene.leftTouchArea);
            b.GameScene.leftTouchArea.addEventListener(egret.TouchEvent.TOUCH_END,
                b.GameScene.areaTouchEvent_up, b.GameScene.leftTouchArea);
            b.GameScene.rightTouchArea = new b.TouchArea(1);
            b.GameScene.rightTouchArea.anchorX = 0.5;
            b.GameScene.rightTouchArea.x = 0.5 * (b.GameScene.winWidth + b.GameScene.leftTouchArea.width) + 20;
            b.GameScene.rightTouchArea.y = b.GameScene.winHeight - 115;
            b.GameScene.contentGroup.addChild(b.GameScene.rightTouchArea);
            b.GameScene.rightTouchArea.addEventListener(egret.TouchEvent.TOUCH_BEGIN, b.GameScene.areaTouchEvent_down, b.GameScene.rightTouchArea);
            b.GameScene.rightTouchArea.addEventListener(egret.TouchEvent.TOUCH_END,
                b.GameScene.areaTouchEvent_up, b.GameScene.rightTouchArea);
            b.GameScene.scoreBg = b.GameScene.createBitmapByName("scoreLabel");
            b.GameScene.scoreBg.anchorX = 1;
            b.GameScene.scoreBg.x = b.GameScene.winWidth;
            b.GameScene.scoreBg.y = 20;
            b.GameScene.bgContainer.addChild(b.GameScene.scoreBg);
            ...
            b.GameScene.scoreLabel.textColor = 16777215;
            b.GameScene.scoreLabel.anchorX = 0.5;
            b.GameScene.scoreLabel.anchorY =
                0.5;
            b.GameScene.scoreLabel.x = b.GameScene.scoreBg.x - 60;
            b.GameScene.scoreLabel.y = b.GameScene.scoreBg.y + 0.5 * b.GameScene.scoreBg.height;
            b.GameScene.bgContainer.addChild(b.GameScene.scoreLabel);
            b.GameScene.timeLabel = b.GameScene.createTextField();
            b.GameScene.timeLabel.text = "00:00";
            b.GameScene.timeLabel.size = 40;
            b.GameScene.timeLabel.textColor = 16777215;
            b.GameScene.timeLabel.anchorX = 0.5;
            b.GameScene.timeLabel.anchorY = 0.5;
            b.GameScene.timeLabel.x = 0.5 * b.GameScene.winWidth;
            b.GameScene.timeLabel.y = b.GameScene.winHeight -
                150;
            b.GameScene.bgContainer.addChild(b.GameScene.timeLabel);
            b.GameScene.timeLeft = 0;
            b.GameScene.leftTimer = new egret.Timer(100, 300);
            b.GameScene.leftTimer.addEventListener(egret.TimerEvent.TIMER, b.GameScene.displayLeftTime, this);
            b.GameScene.leftTimer.addEventListener(egret.TimerEvent.TIMER_COMPLETE, b.GameScene.timesUp, this)
        };
        a.createHand = function() {
            b.GameScene.leftHand_front = b.GameScene.createBitmapByName("left_front_hand");
            b.GameScene.leftHand_front.anchorX = 1;
            b.GameScene.leftHand_front.x = 0;
            b.GameScene.leftHand_front.y =
                50;
            b.GameScene.frontGroup.addChild(b.GameScene.leftHand_front);
            b.GameScene.rightHand_front = b.GameScene.createBitmapByName("right_front_hand");
            b.GameScene.rightHand_front.anchorX = 0;
            b.GameScene.rightHand_front.x = b.GameScene.winWidth;
            b.GameScene.rightHand_front.y = 50;
            b.GameScene.frontGroup.addChild(b.GameScene.rightHand_front);
            b.GameScene.leftHand_back = b.GameScene.createBitmapByName("left_back_hand");
            b.GameScene.leftHand_back.anchorX = 1;
            b.GameScene.leftHand_back.x = -30;
            b.GameScene.leftHand_back.y = 30;
            b.GameScene.backGroup.addChild(b.GameScene.leftHand_back);
            b.GameScene.rightHand_back = b.GameScene.createBitmapByName("right_back_hand");
            b.GameScene.rightHand_back.anchorX = 0;
            b.GameScene.rightHand_back.x = 30 + b.GameScene.winWidth;
            b.GameScene.rightHand_back.y = 30;
            b.GameScene.backGroup.addChild(b.GameScene.rightHand_back)
        };
        a.leftHandRemoveBike_show = function(a, d) {
            var e = egret.Tween.get(b.GameScene.leftHand_front),
                m = egret.Tween.get(b.GameScene.leftHand_back);
            e.to({
                x: b.GameScene.leftHand_back.width
            }, 100).call(function() {
                b.GameScene.leftHandRemoveBike_hide(a).call(d)
            });
            m.to({
                x: b.GameScene.leftHand_back.width - 30
            }, 100)
        };
        a.leftHandRemoveBike_hide = function(a) {
            var d = egret.Tween.get(b.GameScene.leftHand_front),
                e = egret.Tween.get(b.GameScene.leftHand_back);
            d.to({
                x: 0
            }, 100);
            e.to({
        ...
        a.rightHandRemoveBike_show = function(a, d) {
            var e = egret.Tween.get(b.GameScene.rightHand_front),
                m = egret.Tween.get(b.GameScene.rightHand_back);
            e.to({
                x: b.GameScene.winWidth - b.GameScene.rightHand_front.width
            }, 100).call(function() {
                b.GameScene.rightHandRemoveBike_hide(a).call(d)
            });
            m.to({
                x: 30 + b.GameScene.winWidth - b.GameScene.rightHand_front.width
            }, 100)
        };
        a.rightHandRemoveBike_hide = function(a) {
            var d = egret.Tween.get(b.GameScene.rightHand_front),
                e = egret.Tween.get(b.GameScene.rightHand_back);
            d.to({
                x: b.GameScene.winWidth
            }, 100);
            e.to({
                x: 30 + b.GameScene.winWidth
            }, 100);
            egret.Tween.get(a).to({
                x: 1.5 * a.width
            }, 100);
        ...
        a.createBike = function() {
            var a = Math.floor(2 * Math.random());
            return new b.Bike(a)
        };
        a.bikeEnqueue = function() {
            var a = b.GameScene.createBike();
            a.anchorX = 0.5;
            a.anchorY = 0.5;
            a.x =
                0.5 * b.GameScene.winWidth;
            if (1 <= b.GameScene.bikes.length) {
                var d = b.GameScene.bikes[b.GameScene.bikes.length - 1];
                a.y = d.y - d.height + 25
            } else a.y = b.GameScene.winHeight - 270;
            b.GameScene.bikes.push(a);
            b.GameScene.contentGroup.addChild(a)
        };
        a.bikeDequeue = function() {
            if (0 < b.GameScene.bikes.length && b.GameScene.bikeMoving) {
                var a = b.GameScene.bikes[0];
                if (a.getBikeIndex() == b.GameScene.tapEventQueue[0]) {
                    b.GameScene.score++;
					try{
						truemusic.play();
					}catch(e){
                    ...
                    b.GameScene.scoreLabel.text = String(b.GameScene.score);
                    var d = function() {
                        b.GameScene.bikes.shift();
                        b.GameScene.contentGroup.removeChild(a);
                        b.GameScene.bikeEnqueue();
                        for (var d = function() {
                            b.GameScene.tapEventDequeue();
                            1 <= b.GameScene.tapEventQueue.length ? b.GameScene.bikeDequeue() : b.GameScene.bikeMoving = !1
                        }, e = 0; e < b.GameScene.bikes.length; e++) {
                            var g = b.GameScene.bikes[e],
                                g = egret.Tween.get(g).to({
                                    y: g.y + g.height - 25
                                }, 100);
                            e == b.GameScene.bikes.length - 1 && g.call(d)
                        }
                        a.removeSelf();
                        a = null
                    };
                    0 == b.GameScene.tapEventQueue[0] ? b.GameScene.leftHandRemoveBike_show(a, d) : b.GameScene.rightHandRemoveBike_show(a, d)
                } else b.GameScene.bikeMoving = !1, b.GameScene.tapEventDequeue(), b.GameScene.gameOverImgAnimation(!1)
            }
        };
        a.tapEventEnqueue = function(a) {
            b.GameScene.tapEventQueue.push(a);
            b.GameScene.bikeMoving || (b.GameScene.bikeMoving = !0, b.GameScene.bikeDequeue())
        };
        a.tapEventDequeue = function() {
            b.GameScene.tapEventQueue.shift()
        };
        a.displayLeftTime = function(e) {
            b.GameScene.timeLeft+=100;
            if (b.GameScene.isGameOver) b.GameScene.leftTimer.stop();
            else {
                var a = parseInt(b.GameScene.timeLeft / 1000),
                    d = parseInt(b.GameScene.timeLeft %1000/10),
                    e = "00",
                    m = "00",
                    e = 10 > a ? "0" + String(a) : String(a),
                    m = 10 > d ? "0" + String(d) : String(d);
                b.GameScene.timeLabel.text = e + ":" + m
            }
        };
        a.timesUp = function() {
            b.GameScene.leftTimer.stop();
            b.GameScene.gameOverImgAnimation(!0)
        };
        a.areaTouchEvent_down = function(a) {
            b.GameScene.isGameStart || (b.GameScene.timeLeft=0,b.GameScene.leftTimer.start(), b.GameScene.isGameStart = !0);
            b.GameScene.isGameOver || (a = a.target, b.GameScene.touchedBtn || (a.touchDown(), b.GameScene.touchedBtn = a))
        };
        a.areaTouchEvent_up = function() {
            if (!b.GameScene.isGameOver) {
                var a = b.GameScene.touchedBtn;
                b.GameScene.touchedBtn && (a.touchUp(),
                    a = a.getTouchIndex(), b.GameScene.tapEventEnqueue(a), b.GameScene.touchedBtn = null)
            }
        };
        a.gameOverImgAnimation = function(a) {
            b.GameScene.isGameOver = !0;
            var d = "timeOver";
            a || (d = "gameOver");
            a = b.GameScene.createBitmapByName(d);
            a.anchorX = 0.5;
            a.anchorY = 0.5;
            ...
            egret.Tween.get(a).to({
                ...
                scaleX: 1,
                scaleY: 1
            }, 1E3).call(b.GameScene.gotoGameOverScene, 1E3)
        };
        a.gotoGameOverScene = function() {
        ...
        a.gameInfoTouched = function() {
            b.GameScene.gameBg.removeChild(b.GameScene.gameInfo)
        };
        a.createBitmapByName = function(a) {
            var b = new egret.Bitmap;
            a = RES.getRes(a);
    ...
    b.GameScene =
        e;
    e.prototype.__class__ = "robBike.GameScene"
})(robBike || (robBike = {}));
__extends = this.__extends || function(b, e) {
    function d() {
        this.constructor = b
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.initMainUI = function() {
            ...
            this.startBtn.y = 0.8 * this.winHeight - 20;
            ...
            this.moreBtn.y = 0.9 * this.winHeight - 10;
            this.moreBtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.moreGame, this);
            this.bgContain.addChild(this.moreBtn);
            this.initLoadingView();
        };
        a.prototype.initLoadingView = function() {
            var a = this,
                b = new egret.Sprite;
            b.graphics.beginFill(3334376);
            b.graphics.drawRect(0,
                0, this.stage.stageWidth, this.stage.stageHeight);
            b.graphics.endFill();
            this.addChild(b);
            this.loadingLogo = this.createBitmapByName("loadingLogo");
            this.loadingLogo.anchorX = 0.5;
            this.loadingLogo.anchorY = 0.5;
            this.loadingLogo.x = 0.5 * this.stage.stageWidth;
            this.loadingLogo.y = 0.35 * this.stage.stageHeight;
            this.addChild(this.loadingLogo);
            egret.Tween.get(this.loadingLogo).to({}, 1E3).to({
                alpha: 0.2
            }, 1E3).call(function() {
                a.removeChild(b);
                a.removeChild(a.loadingLogo)
            })
        };
    ...
    b.MainMenu = e;
    e.prototype.__class__ = "robBike.MainMenu"
})(robBike || (robBike = {}));
var __extends = this.__extends || function(b, e) {
        function d() {
            this.constructor = b
...
var __extends = this.__extends || function(b, e) {
    ...
    Main = function(b) {
        ...
        e.prototype.onAddToStage = function(b) {
            ...
            RES.loadConfig("/i/games/fkqbg/resource/resource.json",
                "/i/games/fkqbg/resource/")
        };
